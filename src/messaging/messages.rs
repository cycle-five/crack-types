...
pub const FAIL_MISSING_BOT_PERMISSIONS: &str = "⚠️ Missing bot permissions!";
pub const FAIL_MISSING_USER_PERMISSIONS: &str = "⚠️ Missing user permissions!";
...
pub const COULD_NOT_FIND_PERMS: &str = "⚠️ Could not find permissions!";
